        ...
        <div class="col-xs-12">
          ...
          <form class="form-horizontal" id="insertForm" action="submitConfig">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3 col-md-9 col-lg-10">
                <input type="text" class="form-control input-sm" name="source.ENDPOINT" placeholder="http://linkedgeodata.org/sparql" />
              </div>
            ...
            <div class="form-group">
              ...
              <label class="col-sm-3 col-md-3 col-lg-2 control-label">ENDPOINT</label>
              <div class="col-sm-3 col-md-9 col-lg-10">
                <input type="text" class="form-control input-sm" name="target.ENDPOINT" placeholder="http://linkedgeodata.org/sparql" />
              </div>
              <label class="col-sm-3 col-md-3 col-lg-2 control-label">VAR</label>
              <div class="col-sm-3 col-md-9 col-lg-10">
